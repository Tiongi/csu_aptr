...
class ExamPaperModel {
  ...
  factory ExamPaperModel.fromString(String jsonString) => ExamPaperModel.fromJson(json.decode(jsonString));
  ...
  ExamPaperModel.fromSnapshot(DocumentSnapshot<Map<String, dynamic>> snapshot)
      : id = snapshot.id,
