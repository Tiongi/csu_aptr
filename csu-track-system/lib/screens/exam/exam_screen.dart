...
import 'package:quizzle/screens/exam/exam_overview_screen.dart';
              ...
              () => Column(
                children: [
                  if (controller.loadingStatus.value == LoadingStatus.loading)
                    const Expanded(
                        child: ContentArea(child: ExamScreenPlaceHolder())),
                          ...
                          Expanded(
                            child: Obx(
                              () => Visibility(
                                ...
                                child: MainButton(
                                  onTap: () {
                                    controller.islastQuestion ?  Get.toNamed(ExamOverviewScreen.routeName) : controller.nextQuestion();
                                  },
