...
class ResultScreen extends GetView<ExamController> {
  ...
  Widget build(BuildContext context) {
    ExamPaperController _examPprContoller = Get.find();
                ...
                child: ContentArea(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Image.asset("assets/images/TrackExamLogo.png"),
                    ),
                    Text(
                      'Congratulations',
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          ...
                          title: 'Submit and go to exam screen',
                        ))
                      ],
                    )),
              )
